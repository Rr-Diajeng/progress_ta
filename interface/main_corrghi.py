...
LABEL_LEN    = 24                    
PRED_LEN     = 1          
FEATURE_COLS = ["KW","TEMPERATURE","DEW_POINT","RELATIVE HUMIDITY","OT"]
MODEL_PATH   = "./interface/checkpoint/checkpoint_corrghi.pt"
