...
LABEL_LEN    = 24                    
PRED_LEN     = 1          
FEATURE_COLS = ["KW","DEW_POINT","GHI","PRESSURE","WIND_SPEED","RELATIVE HUMIDITY","PRECIPITABLE WATER","CLOUD_TYPE","OT"]
MODEL_PATH   = "./interface/checkpoint/checkpoint_semuatemp.pt"
...
meta = np.load("./interface/checkpoint/scaler_meta_semuatemp.npz", allow_pickle=True)
...
st.title("📈 Dashboard Prediksi OT/Temperature pada Semua Fitur - FEDformer Wavelets (TorchScript)")
